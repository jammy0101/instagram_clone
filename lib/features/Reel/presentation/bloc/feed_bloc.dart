...
//       if (cached.isNotEmpty) emit(FeedLoaded(cached));
//       else emit(FeedError("Failed to load feed: ${err.toString()}"));
//     }
//   }
//
...
//       // optionally re-fetch post to ensure server count
//     } catch (err) {
//       // rollback
...
//       // Optionally increment local commentsCount
//       final current = (state as FeedLoaded).posts;
//       final idx = current.indexWhere((p) => p.id == e.postId);
//       if (idx != -1) {
//         final post = current[idx];
